...
_An e-commerce website consisting of all product lines trending in the market. Easy visit and buy site developed by using the power of Nextjs and Bootstrap, making it more optimised and elegant site ever made._
...
![React Bootstrap](https://img.shields.io/badge/React--Bootstrap-41E0FD?style=for-the-badge&logo=reactbootstrap&logoColor=white)
...
https://e-commerce-store-m7vh.vercel.app/
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Manish-Chatterjee/E-Commerce_Store.git
   ```
